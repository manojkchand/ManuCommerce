...
namespace CoreSite1.Data.Migrations
{
    ...
    [Migration("20221215020633_MapTables1")]
    partial class MapTables1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreSite1.Models.MapImage", b =>
                {
                    ...
                    b.HasIndex("MapStockID");

                    b.ToTable("MapImage");
                });

            modelBuilder.Entity("CoreSite1.Models.MapStock", b =>
                {
                    b.Property<int>("MapStockID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreSite1.Models.MapImage", b =>
                {
                    b.HasOne("CoreSite1.Models.MapStock", null)
                        .WithMany("MapImagelist")
                        .HasForeignKey("MapStockID");
                });
